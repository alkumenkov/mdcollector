 ...
 * </p>
 */
public class TAskBidFixEvent extends TAbstractMarketEvent{
	 ...
	 */
	public TAskBidFixEvent( String aExchName, double aPrice, int aVolume ) {
		super( aExchName );
	...
	public void updateInstrument( TAbstractInstrument aAbstractInstrument ) {
		aAbstractInstrument.getBid( ).get(0).setPrice( fPrice );
		aAbstractInstrument.getBid( ).get(0).setVolume( fVolume );	
